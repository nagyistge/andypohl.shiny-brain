...
ui <- dashboardPage(
  ...
  dashboardBody(
    fluidRow(
         ...
         box(title = "Controls", 
                sliderInput(inputId="slider_x", label="x", min=1, max=197, value=98, step=1),
                sliderInput(inputId="slider_y", label="y", min=1, max=233, value=117, step=1),
                sliderInput(inputId="slider_z", label="z", min=1, max=189, value=94, step=1),
                width=3),
